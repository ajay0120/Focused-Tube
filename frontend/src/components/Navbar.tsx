            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <Link to="/" className="flex items-center gap-3 group">
                        <div className="bg-gradient-to-tr from-fuchsia-500 via-purple-500 to-violet-600 p-2.5 rounded-xl shadow-lg shadow-purple-500/20 ring-1 ring-white/10 group-hover:scale-105 transition-transform">
                        ...
                        <div className="ml-10 flex items-center space-x-4">
                            ...
                            {auth?.user ? (
                                <>
                                    ...
                                    <Link to="/profile" className="w-10 h-10 bg-gradient-to-tr from-fuchsia-500 via-purple-500 to-violet-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-purple-500/20 ring-1 ring-white/10 hover:scale-105 transition-transform" title="Profile">
                                ...
                                <>
                                    ...
                                    <Link to="/register" className="bg-gradient-to-r from-fuchsia-500 via-purple-500 to-violet-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg shadow-purple-500/30 hover:from-fuchsia-600 hover:via-purple-600 hover:to-violet-700 transition-colors">
                                        Get Started
                                    </Link>
                                </>
                            )}
