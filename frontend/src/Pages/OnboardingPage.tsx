    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-3xl mx-auto bg-gray-800 rounded-xl shadow-2xl p-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">
              What are you interested in? (Add up to 10)
            </label>
            <form onSubmit={handleAddInterest} className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-3 bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50 cursor-pointer"
              >
                Add
              </button>
            </form>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">
              What are you NOT interested in? (Add up to 10)
            </label>
            <form onSubmit={handleAddDisinterest} className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-3 bg-red-600 rounded-lg hover:bg-red-700 disabled:opacity-50 cursor-pointer"
              >
                Add
              </button>
            </form>
